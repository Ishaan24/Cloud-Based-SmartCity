...
<html>
    ...
    <body>
        <div id="container">
  <div class="wrapper">
      <h1>Welcome Buddy Please log in to Continue</h1>
         <form name="log" action="JLoginServlet" method="post">
       ...
       <p>Steps to login as a Jobseeker <a href="http://www.google.co.in/">Search Web</a>. This Website is a trade mark of US Corp </p>
